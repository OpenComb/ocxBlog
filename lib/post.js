			...
			function initContentEditor(callback)
			{
				...
				Step(
					function loadScripts()
					{
						...
						jQuery.shipper.require("ocxbootstrap-wysihtml5/public/wysihtml5-0.3.0.js",group()) ;
						jQuery.shipper.require("ocxbootstrap-wysihtml5/public/bootstrap-wysihtml5.js",group()) ;
					}

					, function done(err)
					{
						jQuery.shipper.module("ocxbootstrap-wysihtml5/public/wysihtml5-0.3.0.js") ;
						jQuery.shipper.module("ocxbootstrap-wysihtml5/public/bootstrap-wysihtml5.js") ;
